          ...
          <div class="row">
               ...
               <div class="col-lg-8 col-md-10 mx-auto col-12">
                    <div class="hero-text mt-5 text-center">
                         ...
                         <h1 class="text-white" data-aos="fade-up" data-aos-delay="500">Upgrade your body at Poinsla Fitness</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-flex flex-column justify-content-center ml-lg-auto mr-lg-5 col-lg-5 col-md-6 col-12">
                    <h2 class="mb-3 text-white" data-aos="fade-up">Become a Poinsla member?</h2>

                    <h6 class="mb-4 text-white" data-aos="fade-up">Your membership is up to 2 months FREE (Rp. 30.000 per month)</h6>

                    <p data-aos="fade-up" data-aos-delay="200">Poinsla is the best place to upgrade your helth and body.</p>
